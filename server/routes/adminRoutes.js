...
router.put("/users/:id", roleMiddleware(["admin"]), putUpdateUser);
router.post(
...
router.post("/reports/generate", roleMiddleware(["admin"]), postGenerateReport);
...
router.post(
  ...
  [
    ...
    body("role")
      .isIn(["patient", "doctor", "responder", "admin"])
