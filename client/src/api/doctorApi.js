...
export const addAvailabilitySlots = (slots) =>
  api.post("/doctor/availability", { slots });
export const deleteAvailabilitySlot = (slotId) =>
  api.delete(`/doctor/availability/${slotId}`);
...
export const updateMedicalRecord = (recordId, data) =>
  api.put(`/doctor/records/${recordId}`, data);
...
export const getDoctorPrescriptions = (params) =>
  api.get("/doctor/prescriptions", { params });

// ── Ratings ───────────────────────────────────────────────────────────────────
export const getDoctorRatings = (params) =>
  api.get("/doctor/ratings", { params });

// ── Public ────────────────────────────────────────────────────────────────────
export const getPublicDoctors = (params) =>
  api.get("/doctor/public", { params });
